        ...
        !c &&
            ...
            (E.jstree.core.prototype = {
                    ...
                    this.element
                        .on("dblclick.jstree", function (e) {
                            if (
                                ...
                                return !0;
                            if (b.selection && b.selection.empty)
                                b.selection.empty();
                ...
                load_node: function (n, o) {
                    var e = this.get_node(n, !0),
                        ...
                        s,
                        a;
                    if (E.vakata.is_array(n))
                        return this._load_nodes(n.slice(), o), !0;
                    if (!(n = this.get_node(n)))
                        return o && o.call(this, n, !1), !1;
                    if (n.state.loaded) {
                        for (
                    ...
                    return (
                        ...
                        this._load_node(
                            n,
                            function (e) {
                                ((n = this._model.data[n.id]).state.loading =
                                    !1),
                                    (n.state.loaded = e),
                ...
                _load_nodes: function (e, t, i, r) {
                    for (
                        ...
                        n[e[o]] &&
                            ((!n[e[o]].state.loaded && !n[e[o]].state.failed) ||
                                (!i && r)) &&
                            (this.is_loading(e[o]) || this.load_node(e[o], a),
                            (s = !1));
                    if (s) {
                        for (o = 0, d = e.length; o < d; o++)
                            n[e[o]] && n[e[o]].state.loaded && c.push(e[o]);
                        t && !t.done && (t.call(this, c), (t.done = !0));
                    }
                },
                load_all: function (e, t) {
                    if (((e = e || E.jstree.root), !(e = this.get_node(e))))
                        return !1;
                    var i = [],
                        r = this._model.data,
                        s = r[e.id].children_d,
                        ...
                        n;
                    for (
                        e.state && !e.state.loaded && i.push(e.id),
                            a = 0,
                            n = s.length;
                        a < n;
                        a++
                ...
                _append_html_data: function (e, t, i) {
                    ...
                    for (
                        t.each(
                            function (e, t) {
                                (d = this._parse_model_from_html(
                                    ...
                                    (s.push(d),
                                    a.push(d),
                                    n[d].children_d.length &&
                                        (a = a.concat(n[d].children_d)));
                            }.bind(this)
                        ),
                            o.children = s,
                            o.children_d = a,
                        ...
                        n[o.parents[c]].children_d =
                            n[o.parents[c]].children_d.concat(a);
                            ...
                            a = function (e, c) {
                                ...
                                if (
                                    ...
                                    for (o = 0, d = t.length; o < d; o++)
                                        t[o].children || (t[o].children = []),
                                            t[o].state || (t[o].state = {}),
                                            (u[t[o].id.toString()] = t[o]);
                                    for (o = 0, d = t.length; o < d; o++)
                                        u[t[o].parent.toString()]
                                            ? (u[
                                                  t[o].parent.toString()
                                              ].children.push(
                                                  t[o].id.toString()
                                    ...
                                    for (
                                        o = 0, d = a.parents.length;
                                        o < d;
                                        o++
                                    )
                                        u[a.parents[o]].children_d =
                                            u[a.parents[o]].children_d.concat(
                                                s
                                            );
                                    f = {
                                        cnt: g,
                            ...
                            n = function (e, t) {
                                if (null !== this.element) {
                                    ...
                                    if (((this._model.data = e.mod), t)) {
                                        ...
                                        if (
                                            n.length !== o.length ||
                                            E.vakata.array_unique(n.concat(o))
                                                .length !== n.length
                                        ) {
                                            for (
                                                i = 0, s = n.length;
                ...
                _parse_model_from_html: function (e, t, i) {
                    ...
                    if (
                        ...
                        (t = t.html()),
                        (t = E("<div></div>").html(t)),
                        (n.text = this.settings.core.force_text
                            ? t.text()
                            : t.html()),
                        (t = e.data()),
                        ...
                        for (o in n.data.jstree)
                            n.data.jstree.hasOwnProperty(o) &&
                                (n.state[o] = n.data.jstree[o]);
                    (t = e.children("a").children(".jstree-themeicon"))
                        .length &&
                        (n.icon =
                            !t.hasClass("jstree-themeicon-hidden") &&
                            t.attr("rel")),
                    ...
                    return (
                        (n.id = n.li_attr.id ? n.li_attr.id.toString() : d),
                        t.length
                            ? (t.each(
                                  function (e, t) {
                ...
                _parse_model_from_flat_json: function (e, t, i) {
                    ...
                    if (
                        ...
                        for (n in e.a_attr)
                            e.a_attr.hasOwnProperty(n) &&
                                (l.a_attr[n] = e.a_attr[n]);
                    for (
                        e &&
                            e.children &&
                            !0 === e.children &&
                            ...
                            (l.children_d = [])),
                            n = 0,
                            o = (s[l.id] = l).children.length;
                        n < o;
                        n++
                    )
                        (c =
                            s[
                                (d = this._parse_model_from_flat_json(
                                    s[l.children[n]],
                                    l.id,
                                    i
                                ))
                ...
                draw_children: function (e) {
                    ...
                    if (
                        ...
                        for (
                            (s = a.createElement("UL")).setAttribute(
                                "role",
                                "group"
                            ),
                            ...
                            s.appendChild(
                                this.redraw_node(t.children[i], !0, !0)
                            );
                        e.appendChild(s);
                    }
                },
                redraw_node: function (e, t, i, r) {
                    ...
                    if (
                        ...
                        n = E.inArray(
                            s.id,
                            (null === a ? g[E.jstree.root] : g[s.parent])
                                .children
                        );
                    }
                    for (d in ((e = this._data.core.node.cloneNode(!0)),
                    (h = "jstree-node "),
                    s.li_attr))
                        s.li_attr.hasOwnProperty(d) &&
                            "id" !== d &&
                            ("class" !== d
                    ...
                    if (
                        ...
                        g[s.parent] &&
                        !s.state.hidden &&
                        ((d = E.inArray(s.id, g[s.parent].children)),
                        (k = s.id),
                        -1 !== d)
                    )
                        for (d++, c = g[s.parent].children.length; d < c; d++)
                            if (
                                (k = !g[g[s.parent].children[d]].state.hidden
                                    ? g[s.parent].children[d]
                                    : k) !== s.id
                            )
                                break;
                    ...
                    if (
                        ...
                        this.settings.core.force_text
                            ? e.childNodes[1].appendChild(
                                  _.createTextNode(s.text)
                              )
                        ...
                        for (
                            (l = _.createElement("UL")).setAttribute(
                                "role",
                                "group"
                            ),
                            ...
                            l.appendChild(
                                this.redraw_node(s.children[d], t, !0)
                            );
                        e.appendChild(l);
                    }
                    if ((o && e.appendChild(o), !i)) {
                        for (
                            d = 0,
                                c = (a = a || this.element[0]).childNodes
                                    .length;
                            d < c;
                            d++
                        )
                            if (
                                a.childNodes[d] &&
                                a.childNodes[d].className &&
                                -1 !==
                                    a.childNodes[d].className.indexOf(
                                        "jstree-children"
                                    )
                            ) {
                                p = a.childNodes[d];
                        ...
                        p ||
                            ((p = _.createElement("UL")).setAttribute(
                                "role",
                                "group"
                            ),
                ...
                _open_to: function (e) {
                    if (!(e = this.get_node(e)) || e.id === E.jstree.root)
                        return !1;
                    for (
                        var t, i, r = e.parents, t = 0, i = r.length;
                        t < i;
                        t += 1
                    )
                ...
                activate_node: function (e, t) {
                    ...
                    if (
                        ...
                        this.is_selected(e)
                            ? this.deselect_node(e, !1, t)
                            : ((!this.settings.core.allow_reselect &&
                                  this.is_selected(e) &&
                        ...
                        if (
                            ...
                            for (n in t)
                                t.hasOwnProperty(n) &&
                                    "core" !== n &&
                                    -1 ===
                                        E.inArray(n, this.settings.plugins) &&
                                    delete t[n];
                ...
                set_id: function (e, t) {
                    ...
                    return (
                        -1 !==
                            (i = E.inArray(e.id, this._data.core.selected)) &&
                ...
                create_node: function (e, t, i, r, s) {
                    ...
                    for (
                        ...
                        this._model.data[e.parents[o]].children_d =
                            this._model.data[e.parents[o]].children_d.concat(n);
                    for (
                        t = a, a = [], o = 0, d = e.children.length;
                        o < d;
                        o++
                    )
                        a[i <= o ? o + 1 : o] = e.children[o];
                    return (
                        (a[i] = t.id),
                        (e.children = a),
                ...
                delete_node: function (e) {
                    ...
                    for (
                        -1 !== s &&
                            (r.children = E.vakata.array_remove(r.children, s)),
                ...
                check: function (e, t, i, r, s) {
                    ...
                    var a = e.match(/^(move_node|copy_node|create_node)$/i)
                            ? i
                            : t,
                ...
                move_node: function (e, t, i, r, s, a, n) {
                    ...
                    if (((t = this.get_node(t)), (i = i === P ? 0 : i), !t))
                        return !1;
                    if (
                    ...
                    if (E.vakata.is_array(e)) {
                        if (1 !== e.length) {
                            for (o = 0, d = e.length; o < d; o++)
                                (f = this.move_node(e[o], t, i, r, s, !1, n)) &&
                                    ((t = f), (i = "after"));
                        ...
                        for (
                            ...
                            for (
                                u = [],
                                    v = 0,
                                    j = (k =
                                        _._model.data[e.parents[p]].children_d)
                                        .length;
                                v < j;
                                v++
                            )
                ...
                copy_node: function (e, t, i, r, s, a, n) {
                    ...
                    if (E.vakata.is_array(e)) {
                        if (1 !== e.length) {
                            for (o = 0, d = e.length; o < d; o++)
                                (l = this.copy_node(e[o], t, i, r, s, !0, n)) &&
                                    ((t = l), (i = "after"));
                            return this.redraw(), !0;
                        }
                        e = e[0];
            ...
            (E.jstree.plugins.changed = function (e, a) {
                ...
                (this.trigger = function (e, t) {
                    var i, r;
                    if (
                        ((t = t || {}), "changed" === e.replace(".jstree", ""))
                    ) {
                        t.changed = { selected: [], deselected: [] };
                        for (var s = {}, i = 0, r = n.length; i < r; i++)
                            s[n[i]] = 1;
        ...
        (l.className = "jstree-icon jstree-checkbox"),
                ...
                (this.bind = function () {
                            ...
                            this.element
                                .on(
                                    ...
                                    function (e, t) {
                                        ...
                                        if (-1 !== t.indexOf("up")) {
                                            for (
                                                o = 0, d = r.children_d.length;
                                                o < d;
                                                o++
                                            )
                                                i[r.children_d[o]].children
                                                    .length ||
                                                    a.push(
                                                        i[r.children_d[o]]
                                                            .parent
                    ...
                    (this.get_undetermined = function (e) {
                        ...
                        for (
                            ...
                            if (o[d[i]] && o[d[i]].parents)
                                for (
                                    s = 0, a = o[d[i]].parents.length;
                                    s < a;
                                    s++
                                ) {
                                    if (n[o[d[i]].parents[s]] !== P) break;
                                    o[d[i]].parents[s] !== E.jstree.root &&
                                        ((n[o[d[i]].parents[s]] = !0),
                                        c.push(o[d[i]].parents[s]));
                                }
                        for (
                            this.element
                                .find(".jstree-closed")
                            ...
                            o[c[i]].state[t ? "selected" : "checked"] ||
                                h.push(e ? o[c[i]] : c[i]);
                        return h;
                    }),
                        ...
                        for (i = 0, r = e.children_d.length; i < r; i++)
                            if (
                                ...
                                (!n[e.children_d[i]].state.loaded &&
                                    n[e.children_d[i]].original.state
                                        .undetermined)
                            )
                                return !0;
                        return !1;
                    ...
                    (this.delete_node = function (e) {
                        if (
                            ...
                            return d.delete_node.call(this, e);
                        var t,
                            i,
                            r,
                            s = !1;
                    ...
                    (this.load_node = function (e, t) {
                        ...
                        if (
                            ...
                            for (i = 0, r = o.children_d.length; i < r; i++)
                                this._model.data[o.children_d[i]].state
                                    .checked &&
                                    (this._data.checkbox.selected =
                                        E.vakata.array_remove_item(
                                            this._data.checkbox.selected,
            ...
            ((h = E).vakata.context = {
                ...
                _show_submenu: function (e) {
                    ...
                    (e = h(e)).length &&
                        ...
                        (a = t.width()),
                        (n = t.height()),
                        (o = h(window).width() + h(window).scrollLeft()),
                        (d = h(window).height() + h(window).scrollTop()),
                        _
                            ? e[
                ...
                show: function (e, t, i) {
                    var r,
                        ...
                        l = !0;
                    switch (
                        (g.element && g.element.length && g.element.width(""),
                        !0)
                    ) {
                        case !t && !e:
                            return !1;
                            ...
                            if (n && n._data && n._data.dnd)
                                if (
                                    ...
                                    (s.event.target !== n.element[0] &&
                                        s.event.target !==
                                            n.get_container_ul()[0]) ||
                                        (0 !==
                                            n.get_container_ul().children()
                                                .length &&
                                            !n.settings.dnd.blank_space_drop))
                                ) {
                                    if (
                                        (o = n.settings.dnd.large_drop_target
                                            ? E(s.event.target)
                                                  .closest(".jstree-node")
                                                  .children(".jstree-anchor")
                    ...
                    .on("dnd_stop.vakata.jstree", function (e, t) {
                        if (
                            ...
                            if (N) {
                                ...
                                (i = E(t.event.target).closest(".jstree"))
                                    .length &&
                                    T &&
                                    T.error &&
                                    "check" === T.error &&
            ...
            (f.vakata.dnd = {
                ...
                _scroll: function (e) {
                    ...
                    if (!p.scroll_i)
                        return (
                            (p.scroll_i = setInterval(
                                f.vakata.dnd._scroll,
                                100
                            )),
                            !1
                        );
                    ...
                    (this.search = function (r, e, t, i, s, a) {
                        ...
                        if (
                            ...
                            return E.vakata.is_function(o)
                                ...
                                : ((o = E.extend({}, o)).data || (o.data = {}),
                                  (o.data.str = r),
                                  i && (o.data.inside = i),
                                  this._data.search.lastRequest &&
                                      this._data.search.lastRequest.abort(),
                                  (this._data.search.lastRequest = E.ajax(o)
                                      .fail(
                                          function () {
                                              (this._data.core.last_error = {
                                                  error: "ajax",
                        ...
                        if (
                            ...
                            for (
                                _ = 0,
                                    g = (h = E.vakata.array_unique(h)).length;
                                _ < g;
                                _++
                            )
                                h[_] !== E.jstree.root &&
            ...
            ((w = E).vakata.search = function (p, e, m) {
                (m = m || {}),
                    !1 !==
                        (m = w.extend({}, w.vakata.search.defaults, m)).fuzzy &&
                        (m.fuzzy = !0),
                ...
                (this.init = function (e, t) {
                    ...
                    (this.get_json = function (e, t, i) {
                        ...
                        if (E.vakata.is_array(o))
                            ...
                            (o.type =
                                (o.id || 0 === o.id) && a[o.id] && a[o.id].type
                                    ? a[o.id].type
                                    : "default"),
                        ...
                        switch (e) {
                            ...
                            case "copy_node":
                                if (
                                    ...
                                    if (
                                        (n = this.get_rules(i)).max_children !==
                                            P &&
                                        -1 !== n.max_children &&
                                    ...
                                    if (a && t.children_d && t.parents) {
                                        for (
                                            d = o = 0, c = t.children_d.length;
                                            d < c;
                                            d++
                                        )
                                            o = Math.max(
                                                o,
                                                a[t.children_d[d]].parents
                                                    .length
                                            );
                    ...
                    (this.set_type = function (e, t) {
                        ...
                        if (
                            ...
                            for (d in r[n].li_attr)
                                r[n].li_attr.hasOwnProperty(d) &&
                                    "id" !== d &&
                                    ("class" === d
                                        ? ((i[e.id].li_attr.class = (
                                              i[e.id].li_attr.class || ""
                                          ).replace(r[n].li_attr[d], "")),
                                          c && c.removeClass(r[n].li_attr[d]))
                                        : i[e.id].li_attr[d] ===
                                              r[n].li_attr[d] &&
                        ...
                        if (
                            r[n] &&
                            r[n].a_attr !== P &&
                            "object" == typeof r[n].a_attr
                        )
                            for (d in r[n].a_attr)
                                r[n].a_attr.hasOwnProperty(d) &&
                                    "id" !== d &&
                                    ("class" === d
                                        ? ((i[e.id].a_attr.class = (
                                              i[e.id].a_attr.class || ""
                                          ).replace(r[n].a_attr[d], "")),
                                          l && l.removeClass(r[n].a_attr[d]))
                                        : i[e.id].a_attr[d] ===
                                              r[n].a_attr[d] &&
                                          ("href" === d
                                              ? ((i[e.id].a_attr[d] = "#"),
                        ...
                        if (
                            r[t].li_attr !== P &&
                            "object" == typeof r[t].li_attr
                        )
                            for (d in r[t].li_attr)
                                r[t].li_attr.hasOwnProperty(d) &&
                                    "id" !== d &&
                                    (i[e.id].li_attr[d] === P
                                        ? ((i[e.id].li_attr[d] =
                                              r[t].li_attr[d]),
                                          c &&
                                              ("class" === d
                                                  ? c.addClass(r[t].li_attr[d])
                                                  : c.attr(d, r[t].li_attr[d])))
                                        : "class" === d &&
                                          ((i[e.id].li_attr.class =
                                              r[t].li_attr[d] +
                                              " " +
                        ...
                        if (r[t].a_attr !== P && "object" == typeof r[t].a_attr)
                            for (d in r[t].a_attr)
                                r[t].a_attr.hasOwnProperty(d) &&
                                    "id" !== d &&
                                    (i[e.id].a_attr[d] === P
                                        ? ((i[e.id].a_attr[d] = r[t].a_attr[d]),
                                          l &&
                                              ("class" === d
                                                  ? l.addClass(r[t].a_attr[d])
                                                  : l.attr(d, r[t].a_attr[d])))
                                        : "href" === d &&
                                          "#" === i[e.id].a_attr[d]
                                        ? ((i[e.id].a_attr.href =
                                              r[t].a_attr.href),
            ...
            (E.jstree.plugins.unique = function (e, f) {
                (this.check = function (e, t, i, r, s) {
                    ...
                    if (
                        ((t = t && (t.id || 0 === t.id) ? t : this.get_node(t)),
                        !(i =
                            i && (i.id || 0 === i.id) ? i : this.get_node(i)) ||
                            !i.children)
                    )
                        return !0;
                    for (
                    ...
                    (this.create_node = function (e, t, i, r, s) {
                        if (!t || ("object" == typeof t && t.text === P)) {
                            ...
                            while (-1 !== E.inArray(u, o))
                                (u = n = g.call(this, a, ++d).toString()),
                                    h || (u = u.toLowerCase()),
                                    _ &&
                                        (u = u.replace(
                                            /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
                    ...
                    (this.redraw_node = function (e, t, i, r) {
                        ...
                        return (
                            (e = a.redraw_node.apply(this, arguments)) &&
                                ((s = j.cloneNode(!0)),
                                -1 !==
                                    E.inArray(e.id, this._data.core.selected) &&
